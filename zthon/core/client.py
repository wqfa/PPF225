                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @C15CS\
                                  \n\n--------بـدء تتبـع سجـل ريـدثـيون 𝗥𝗘𝗗𝗧𝗛𝗢𝗡--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ريـدثـيون 𝗥𝗘𝗗𝗧𝗛𝗢𝗡--------"
                        ...
                        link = "[المطور 👤 (https://t.me/C15CS)"
                        text = (
                            "**✘ تقـريـر إشعـار تيبثـون 𝗥𝗘𝗗𝗧𝗛𝗢𝗡 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ريـدثـيوت 𝗥𝗘𝗗𝗧𝗛𝗢𝗡--------"
                        command = 'git log --pretty=format:"%an: %s" -5'
                        ftext += "\n\n\n- آخـر 5 ملفـات تم تحديثهـا :\n"
                        output = (await runcmd(command))[:2]
                        result = output[0] + output[1]
                        ...
                        text = "**✘ تقـريـر إشعـار تيبثـون 𝗥𝗘𝗗𝗧𝗛𝗢𝗡 ✘**\n\n "
                        link = "[المطور 👤 (https://t.me/C15CS)"
