...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗘𝗗𝘁𝗵𝗼𝗻 - أوامـر الصيد والتشيكـر](t.me/RedTheon) 𓆪\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗘𝗗𝘁𝗵𝗼𝗻 - أنـواع اليـوزرات](t.me/RedTheon) 𓆪\n\n"

"**✾╎قـائمـة أنـواع اليـوزرات التي يمكـن صيدهـا مـع الأمثـلة :** \n\n"

"⪼  `.صيد ثلاثيات`  **مثـال ~** X_R_D\n"
...
"**⪼ لـ رؤيـة بعـض الاوامر التي قام بها منصبيـن ريدثيون**"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد ريدثيون 𝗥𝗘𝗗𝘁𝗵𝗼𝗻 ⎉",

                    about="This channel to hunt username by - @RedTheon ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت ريدثيون 𝗥𝗘𝗗𝘁𝗵𝗼𝗻 ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس ريدثيون - @RedTheon ",
