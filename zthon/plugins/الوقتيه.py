...
حقـوق للتـاريخ : @RedRheon
@C15CS - كتـابـة الملـف :   الحجي"""
# يولـد هههههههههههههههههههههههههه
...
ZelzalVP_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗘𝗗𝗧𝗛𝗢𝗡 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/RedRheon) 𓆪\n\n"
    ...
    "⪼ `.وقتيه 16`\n\n"
    "⪼ `.وقتيه 17`\n\n\n"
    "**✾╎لـ رؤيـة زغـارف البروفايـل الوقتـي ↶**  [⦇  اضـغـط هنــا  ⦈](t.me/RRedRheon \n\n"
    "**✾╎لـ رؤيـة زغـارف الاســم الوقتـي ↶**  [⦇  اضـغـط هنــا  ⦈](t.me/RedRheon) \n\n\n"
